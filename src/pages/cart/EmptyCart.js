        ...
        <main>
            <section>
                ...
                <div className="w-full p-4 text-center bg-white border border-gray-200 rounded-lg shadow-sm sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                    <h3><i className="bi bi-basket-fill text-5xl text-black mb-4 dark:text-white"></i></h3>
                    <h5 className="mt-4 mb-2 text-3xl font-bold text-gray-900 dark:text-white">Your Cart is Empty</h5>
                    <p className="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">Please add something to.</p>
